...
import nobaddays.runman.domain.Person;
import nobaddays.runman.repository.PersonRepository;
...
/**
 * REST controller for managing {@link nobaddays.runman.domain.Person}.
 */
@RestController
@RequestMapping("/api")
public class PersonResource {
     ...
     */
    @GetMapping("/people")
    public ResponseEntity<List<Person>> getAllPeople(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
