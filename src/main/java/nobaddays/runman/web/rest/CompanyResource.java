...
import nobaddays.runman.domain.Company;
import nobaddays.runman.repository.CompanyRepository;
...
/**
 * REST controller for managing {@link nobaddays.runman.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    public ResponseEntity<List<Company>> getAllCompanies(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
