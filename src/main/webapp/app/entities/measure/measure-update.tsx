...
export class MeasureUpdate extends React.Component<IMeasureUpdateProps, IMeasureUpdateState> {
  ...
  render() {
    const { measureEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="runeManApp.measure.home.createOrEditLabel">Create or edit a Measure</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
